...
def draw_cat_plot():
    ...
    cat_fig = sns.catplot(x='variable',y='total',kind='bar',hue='value',data=df_cat, errorbar=None)
    #cat_fig.set_axis_labels("variable", "total")
...
def draw_heat_map():
    ...
    sns.heatmap(corr, annot=True, fmt='.1f', mask=mask, vmax=.3, vmin=0, square=True, linewidths=.5, center=0)
